...
{
    public interface IAssetOwnerRepository : IAddableRepository<AssetOwner>, IUpdatableRepository<AssetOwner>,
        IDeletableRepository<AssetOwner>, ISelectableRepository<AssetOwner>
    {
    }
}
