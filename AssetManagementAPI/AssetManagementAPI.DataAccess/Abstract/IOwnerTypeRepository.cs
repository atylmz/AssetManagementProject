...
{
    public interface IOwnerTypeRepository : IAddableRepository<OwnerType>, IUpdatableRepository<OwnerType>,
        IDeletableRepository<OwnerType>, ISelectableRepository<OwnerType>
    {
    }
}
