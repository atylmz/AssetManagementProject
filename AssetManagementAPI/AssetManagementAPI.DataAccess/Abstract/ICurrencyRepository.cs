...
{
    public interface ICurrencyRepository : IAddableRepository<Currency>, IUpdatableRepository<Currency>,
        IDeletableRepository<Currency>, ISelectableRepository<Currency>
    {
    }
}
